public class RecurseBuggy{
	...
	public static void main(String[] args){
		...
		assert check1 == true: "Check1 incorrect"; 
		assert check2 == false: "Check2 incorrect";  
	}
}